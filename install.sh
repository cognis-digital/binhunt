#!/usr/bin/env sh
# Universal installer for binhunt. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/binhunt.git"
echo "Installing binhunt ..."
